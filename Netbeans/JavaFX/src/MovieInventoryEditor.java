...
Label lblHeading = new Label("Book Inventory");
...
TableColumn colYear = new TableColumn("Copies");
       ...
       String line="";
        ...
        try {
            ...
            while((line = bufferedReader.readLine()) != null) {
                ...
                //String [] numberLine = splitLine[0].split(".");
                String [] splitAgain = splitLine[1].split("#");
                line=splitAgain[0]; 
                int copies = Integer.parseInt(splitAgain[1]);
                //Double number = Double.parseDouble(numberLine[0]);//.parseInt(numberLine[0]);
                data.add(new Movie(line,copies,14.25));
